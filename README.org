...
*** metrics list report
    ...
    emacs diary.  the list report is like a dashboard.  it gives you a
    broad overview of everything you're tracking.
    ...
    the list report has the following columns:
...
* gallery
  ...
  - [[https://ianxm-githubfiles.s3.amazonaws.com/emacs-tracker/0_list_60pct_v2.png][https://ianxm-githubfiles.s3.amazonaws.com/emacs-tracker/0_list_20pct_v2.png]] ::  this
       is a metric list report.  it lists all metrics found in the
