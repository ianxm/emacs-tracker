[[https://melpa.org/#/metrics-tracker][file:https://melpa.org/packages/metrics-tracker-badge.svg]] [[https://img.shields.io/badge/license-GPL_3-green.svg][file:https://www.gnu.org/licenses/gpl-3.0.txt]]
...
** installation
   ...
   metrics-tracker.el is available via ELPA, from the MELPA
   repository.  it can be installed with ~M-x package-install RET
   metrics-tracker RET~.
